...
if( isset($_POST['submit']) && isset($_POST['link_post']) && isset($_POST['amount']) && isset($_POST['comment'])){
$amount=$_POST['amount'];
...
$url="https://muasubngon.com/api/service/order-comment";
...
$ch = curl_init();
    ...
    curl_setopt( $ch, CURLOPT_POSTFIELDS, "link_post=".$link_post."&amount=".$amount."&note=".$note."&comment=".$comment);
	$headers = array(
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10"><textarea class="form-control" name="comment" rows="5" placeholder="Nhập nội dung comment (Mỗi Nội Dung 1 Dòng)"></textarea></div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <ul class="pt-2">
                                        <li>Mua bằng link bài viết đã mở chế độ công khai.</li>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 text-center">
                                <div class="alert alert-dismissible alert-success">
                                    <h3 class="font-bold">
                                        Tổng thanh toán: <span class="bold green"><span id="total_payment" class="text-danger"><?=$ratecmt * 100?></span> VNĐ</span>
                                    </h3>
                                </div>
                            </div>
                        </div>
...
$url="https://muasubngon.com/api/service/list-comment";
...
while($row = mysqli_fetch_assoc($result)){
    ...
    <td role="cell"><?=$arr["buff"]?></td>
     <td role="cell"><textarea class="form-control" rows="3" readonly="" style="min-width: 150px;"><?=$arr["comment"]?></textarea></td>

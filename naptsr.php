                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-borderless mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Thesieure.com</td>
                                        <td>
                                            <b class="text-success" id="username_tsr"><?=$site_tk_tsr;?></b> <a class="copy"
                            data-clipboard-target="#username_tsr"><i class="fa fa-copy"></i></a>
                                        </td>
                                        <td><b class="text-success"><?=$site_ten_tk_tsr;?></b></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="card-pair"><b class="text-danger" id="content_momo"><?=$site_nd_tsr;?> <?=$user["username"]?></b><a class="copy"
                            data-clipboard-target="#content_momo"><i class="fa fa-copy"></i></a></div>
                            
                        </div>
                        <center><a href="cron/thesieure/congtien.php"><button class="btn btn-success">Cộng Tiền</button></a></center>
                    </div>
                </div>
            </div>
        </div>
...
<?php
$i = 0;
$result = mysqli_query($ketnoi,"SELECT * FROM `tsr` WHERE `username` = '".$user['username']."'");
